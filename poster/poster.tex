	...
	\begin{columns}[onlytextwidth, T]
		\begin{column}{.48\textwidth}
			\begin{block}{Verfahren 1: Sichtprüfung durch Lichtstreuung}
				...
				\begin{figure}
					...
					\end{tikzpicture}
					\caption{Hervorhebung von Defekten auf einem Brillenglas}
				\end{figure}
				\vspace{-0.75\baselineskip}
			\end{block}
		\end{column}
		...
		\begin{column}{.48\textwidth}
			\begin{block}{Verfahren 2: Deflektometrische Registrierung}
				...
				\par\bigskip
				Zur Bestimmung der deflektometrischen Registrierung können Sequenzen von sinusoidalen Streifenmustern (siehe Abbildung links) zur Kodierung verwendet werden. 
