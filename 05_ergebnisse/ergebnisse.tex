...
% Abbildung: Fotos der verwendeten Aufbauten
{
	\begin{figure}[H]
		\centering
		\input{05_ergebnisse/figures/abbAufbauFotos}
...
%Sichtprüfung durch Lichtstreuung
{
    ...
    \input{05_ergebnisse/ergSichtpruefungDurchLichtstreuung/ergSichtpruefungDurchLichtstreuung}
}
...
%Deflektometrische Registrierung
{
    ...
    \input{05_ergebnisse/ergDeflektometrischeRegistrierung/ergDeflektometrischeRegistrierung}
}
...
%Diskussion
{
    ...
    \input{05_ergebnisse/ergDiskussion/ergDiskussion}
}