\begin{adjustbox}{width=\textwidth}
	...
	\end{tikzpicture}
\end{adjustbox}
\caption[Darstellung Spalten- und Zeilenregistrierung eines Brillenglases]{Darstellung von Spalten- und Zeilenregistrierung als Bilder. Abweichungen vom linearen Verlauf entstehen durch tiefe Eingravierungen im Glas. Das Muster wurde als Durchlicht direkt über der Kamera beobachtet.}