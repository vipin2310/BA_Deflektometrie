...
% Abbildung: Optimale Spalten- und Zeilenregistrierung
{
	\begin{figure}[H]
		\centering
		\input{04_deflektometrischeRegistrierung/auswertungDeflektometrischeRegistrierung/figures/abbOptimaleSpaltenZeilenReg}
...
% Abbildung: Brillenglas Registrierung
{
	\begin{figure}[H]
		\centering
		\input{04_deflektometrischeRegistrierung/auswertungDeflektometrischeRegistrierung/figures/abbBrillenglasRegistrierung}
...
% Abbildung: Deflektometrische Registrierung bei Objekt mit Delle
{
	\begin{figure}[H]
		\centering
		\input{04_deflektometrischeRegistrierung/auswertungDeflektometrischeRegistrierung/figures/abbRegistrierungDelle}
...
Durch die weichen Grauwertverläufe an gleichmäßig gekrümmten Oberflächen in den \acrshort{frx} und \acrshort{fry}, lassen sich die Bilder effizient über ihre Gradienten analysieren (siehe Abbildung \ref{tikz:abbGradientenbildReg}).
...
% Abbildung: Gradientenbild der deflektometrischen Registrierung.
{
	\begin{figure}[H]
		\centering
		\input{04_deflektometrischeRegistrierung/auswertungDeflektometrischeRegistrierung/figures/abbGradientenbildReg}
...
Dies kann allerdings auch zum Vorteil genutzt werden, wenn nur die speziellen Informationen gesucht werden.