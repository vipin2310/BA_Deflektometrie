\begin{adjustbox}{width=\textwidth}
	\begin{tikzpicture}
		...
		% Funktion 1
		\draw[name path = func1, blue, thick, domain=0:15, samples=600] plot (\x,{1.875*cos(((2*pi*3)/15)*\x r) + 1.875}) node[anchor=north west] {$N_\lambda^1 = 3$};
		
		% Funktion 2
		\draw[name path = func2, blue, thick, domain=0:15, samples=600] plot (\x,{1.875*cos(((2*pi*4)/15)*\x r) - 3.625}) node[anchor=north west] {$N_\lambda^2 = 4$};
		
		% Funktion 3
		\draw[name path = func3, blue, thick, domain=0:15, samples=600] plot (\x,{1.875*cos(((2*pi*6)/15)*\x r) - 9.125}) node[anchor=north west] {$N_\lambda^3 = 6$};
