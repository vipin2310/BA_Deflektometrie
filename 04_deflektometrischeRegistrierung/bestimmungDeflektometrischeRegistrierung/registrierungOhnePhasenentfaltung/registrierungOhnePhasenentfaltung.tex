...
Durch die Reflexion an der Oberfläche trifft der Sichtstrahl ausgehend vom Bildpunkt $(x_B, y_B)^\top \in A_{Cam}$ den Monitor im Punkt $(x_L, y_L)^\top \in L \cup \varnothing$, welcher durch die Abbildung aus der Gleichung \ref{eq:deflektometrischeRegistrierungAbbildung} bestimmt wurde:
%
\begin{equation}
	\begin{pmatrix}
		x_L \\ 
...
\end{equation}
%
Setzt man für $m_k$ die Gleichung \ref{eq:monitormuster} unter Berücksichtigung der Veränderung durch die Oberfläche ein, erhält man:
%
