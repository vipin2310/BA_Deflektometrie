...
% Abbildung: Glatte und Raue Oberfläche
{
	\begin{figure}[H]
		\centering
		\input{02_grundlagenDerDeflektometrie/spiegelndeOberflaechen/figures/abbGlattUndRau}
...
% Abbildung: Glatte und Raue Oberfläche
{
	\begin{figure}[H]
		\centering
		\input{02_grundlagenDerDeflektometrie/spiegelndeOberflaechen/figures/abbDeflektometrieVSProjektion}
