\begin{adjustbox}{width=\textwidth}
	\begin{tikzpicture}
		...
		% Beschriftung für f
		\draw[blue,thick] node[anchor=east] at (8,2.125) {$s_{\tfrac{1}{3}}(t)$};
		
		
		% Koordinatensystem 2
		\draw[thick,-stealth,black] (-8,-5)--(8,-5) node[below] {$t$};
		\draw[thick,-stealth,black] (0,-7.125)--(0,-2.875);
		...
		% Beschriftung für Funktion 2
		\draw[Green,thick] node[anchor=east] at (8,-2.875) {$s_{\tfrac{1}{4}}(t)$};
		
	\end{tikzpicture}
\end{adjustbox}
\caption[Rechteckschwingung bzw. \textit{engl.: square wave}]{Einheitsrechteckschwingung (\textit{engl.: square wave}) für $f = \tfrac{1}{3}$ (in blau) und $f = \tfrac{1}{4}$ (in grün).}