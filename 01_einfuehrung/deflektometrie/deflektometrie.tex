...
%Rekonstruktion von spiegelnden Oberflächen
{
    ...
    \input{01_einfuehrung/deflektometrie/rekonstruktion/rekonstruktion}
}
...
%Qualitative Sichtprüfung
{
    ...
    \input{01_einfuehrung/deflektometrie/qualitativeSichtpruefung/qualitativeSichtpruefung}
}